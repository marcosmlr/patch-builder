...
"""Configuration file for the Python Library for Patches Creator documentation.
...
project = 'PATCH_BUILDER'
copyright = '2021, INPE.'
author = 'Brazil Data Cube Team'
release = patch_builder.__version__
...
html_title = 'PATCH_BUILDER'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'patch-builder',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#PATCH_BUILDER_EXAMPLE_URL = os.getenv('PATCH_BUILDER_EXAMPLE_URL', None)
#'''

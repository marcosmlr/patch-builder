...
setup(
    ...
    url='https://github.com/brazil-data-cube/patch-builder',
    project_urls={
        'Repository': 'https://github.com/brazil-data-cube/patch-builder',
        'Issues': 'https://github.com/brazil-data-cube/patch-builder/issues',
